...
?>
  <div class="container mt-5">
      <form action="gio-hang.php" method="post">
              ...
              <table class="table table-striped">
                  ...
                  <tbody>
                      ...
                      <tr>
                          ...
                          <td><input type="number" min="1" name="qty[<?php echo $item['product_id']; ?>]" value="<?php echo $item['quantity']; ?>" class="form-control"></td>
                          <td><?php echo number_format($subtotal); ?> đồng</td>
                          <td><a href="gio-hang.php?action=remove&id=<?php echo $item['product_id']; ?>"><button type="button" class="btn btn-danger">Xóa</button></a></td>
                      </tr>
                      <?php } ?>
                      <tr>
          ...
          <br>
          <input type="submit" style="margin: 10;" name="update_cart" value="Cập nhật giỏ hàng" class="btn btn-primary">
          <a href="./thanh-toan.php" style="margin: 10px;" class="btn btn-success">Thanh Toán</a>
      </form>
  </div>
  
<?php 
} else {
    echo "<center><h3>Không có sản phẩm nào trong giỏ hàng.</h3></center>";
}
include "./footer.php";
